...
const ContactDetail = ({ updateContact, updateImage, onContactDeleted }) => {
  ...
  const clientDeleteContact = async () => {
    try {
          ...
          <div>
            <form onSubmit={onUpdateContact} className="form">
              ...
              <div className="user-details">
                {/* pass id so server knows to update existing contact instead of creating new conctact.
                    can be hidden since we just need the value for the api */}
                <input
                  type="hidden"
              ...
              <div className="form_footer">
                ...
                <Link to={"/contacts"}>
                  <button type="button" className="btn btn-danger" onClick={clientDeleteContact} >
                    Delete
                  </button>
                </Link>
              </div>
